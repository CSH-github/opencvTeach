...
#                         default="/home/cunrui/tmp/face/weiwuer_v/",
#                         help='Image files to process')
# ARG_PARSER.add_argument('-v', '--verbose', dest='verbose', action='store_true',
#                         help='Verbose output')
# ARG_PARSER.add_argument('-p', '--predictor-path', dest='predictor_path',
#                         default="/home/cunrui/tmp/shape_predictor_68_face_landmarks.dat",
...
# cvimg = np.array(MEAN_IMG ,dtype=float)/float(255)
# # cvimg =cv2..fromarray(MEAN_IMG)
# cv2.imwrite('/home/cunrui/'+faces_folder_path[21:len(faces_folder_path)-1]+'.png', cvimg,[int(cv2.IMWRITE_PNG_COMPRESSION), 9])
